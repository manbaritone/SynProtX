...
SAVER_LOGGER = logging.getLogger("SynProtXgat.Saver")
MISC_LOGGER = logging.getLogger("SynProtXgat.MISC")
...
class SynProtXgat_predictor(nn.Module):
    def __init__(
        self,
        node_feat_size: int,
        out_channels: int,
...
def model_tuning(
    ...
    for fold in range(FOLDS):
        ...
        # print('---- SynProtXgat Model Architecture ----')
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Model configuration for SynProtXgat Model"
    )
    parser.add_argument(
        "-d",
        "--database",
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="if added, disable GAT for molecule",
    )
    parser.add_argument(
        "--no-feagene",
        dest="no_feagene",
